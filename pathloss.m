...
n1 = 3;% Pathloss exponent
n2 = 4;% Pathloss exponent
...
[OP1,SER1,CAP1] = OP_SER_CAP(m1,m2,Omega11,Omega22,PbdB,PrdB,gamThdB,N0,NOL,NB,NR1,NR2,NU,a_MPSK,b_MPSK);
[OP2,SER2,CAP2] = OP_SER_CAP(m1,m2,Omega111,Omega222,PbdB,PrdB,gamThdB,N0,NOL,NB,NR1,NR2,NU,a_MPSK,b_MPSK);
